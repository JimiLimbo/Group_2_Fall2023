...
SELECT AgentFirstName + ' ' + AgentLastName AS [Agent Name], AgentPhone AS [Agent Phone #]
FROM Agents
ORDER BY [Agent Name];

--2. Create a list of customers by city
SELECT CustFirstName + ' ' + CustLastName AS [Customer Name], CustCity AS [Customer City]
FROM Customers
